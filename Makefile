...
coverage:
	...
	uv run --python 3.11 pytest ./tests --cov=./spice_solver/ --cov-report=html
	# run tests with Python 3.13; with optional dependencies & append to report
	uv run --all-extras --python 3.13 pytest ./tests --cov=./spice_solver/ --cov-append --cov-report=html
